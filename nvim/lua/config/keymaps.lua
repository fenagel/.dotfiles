...
keymap("n", "<leader>r", "<Cmd>w<CR>", { desc = "Write" })
...
-- surrounding words
keymap("n", "<leader>wsq", 'ciw""<Esc>P', { desc = "Word Surround Quotes" })
...
keymap("n", "<leader>oo", ":cd $HOME/Library/Mobile\\ Documents/iCloud~md~obsidian/Documents/Second\\ Brain<cr>")
--
