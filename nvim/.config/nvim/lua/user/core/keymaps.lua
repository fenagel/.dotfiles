...
-- lazy
map("n", "<leader>li", "<cmd>Lazy<cr>", { desc = "Lazy" })
...
-- map("n", "<leader>ge", [[oif err != nil {<CR>return nil, err<CR>}<CR><esc>kkI<esc>]])
-- map("n", "<leader>gs", "<cmd>GoFillStruct<CR>")
-- map("n", "<leader>gw", "<cmd>GoFillSwitch<CR>")
