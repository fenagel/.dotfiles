...
return {
  ...
  --   end,
  -- },
, -- return { --   "crispybaccoon/aki", --   ---@type aki.types.Config --   opts = { --     theme = "hard", --     override_terminal = true, --     transparent_background = true, --     contrast_dark = "hard", --     contrast_light = "medium", --     emphasis = {
  -- {
  --   'RRethy/nvim-base16',
  --   lazy = false,
  --   priority = 1000,
