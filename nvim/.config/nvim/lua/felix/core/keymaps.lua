...
keymap.set("n", "<leader>ve", "<C-w>=", { desc = "Make splits equal size" }) -- make split windows equal width & height
keymap.set("n", "<leader>vx", "<cmd>close<CR>", { desc = "Close current split" }) -- close current split window
