...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  ["formatter.nvim"] = {
    config = { 'require("setup/formatter")' },
    loaded = true,
  ...
  ["nightfox.nvim"] = {
    ...
    loaded = true,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/start/nightfox.nvim",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  ["telescope.nvim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/opt/telescope.nvim",
  ...
  ["vim-vsnip-integ"] = {
    loaded = true,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/start/vim-vsnip-integ",
