...
_G.packer_plugins = {
  ...
  ["auto-pairs"] = {
    loaded = true,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/start/auto-pairs",
  ...
  neoformat = {
    loaded = true,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/start/neoformat",
    url = "https://github.com/sbdchd/neoformat"
  },
  ["nerdtree-git-plugin"] = {
    loaded = true,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/start/nerdtree-git-plugin",
  ...
  ["vim-devicons"] = {
    loaded = true,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/start/vim-devicons",
  ...
  ["vim-man"] = {
    loaded = true,
    path = "/Users/felix/.local/share/nvim/site/pack/packer/start/vim-man",
