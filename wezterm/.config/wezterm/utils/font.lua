...
M.get_font = function()
	...
	-- return wezterm.font_with_fallback({ { family = "Monaspace Xenon", weight = "Regular" } })
	return wezterm.font("JetBrainsMono Nerd Font", { bold = true })
	...
	-- return wezterm.font("Hack Nerd Font", { weight = "Bold" })
	-- 	-- return wezterm.font("Menlo")
	-- return wezterm.font("Source Code Pro")
	-- 	--
end
